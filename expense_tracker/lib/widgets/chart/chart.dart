...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ExpenseBucket.forCategory(registeredExpenses, Category.food),
      ExpenseBucket.forCategory(registeredExpenses, Category.leisure),
      ExpenseBucket.forCategory(registeredExpenses, Category.travel),
      ExpenseBucket.forCategory(registeredExpenses, Category.work),
    ];
  }
